...
import subprocess
from Tkinter import Tk, Canvas, Frame, Scrollbar, Label, Entry, Button, Menu, Menubutton, Listbox, StringVar, IntVar, RAISED
...
def writingFile():
    ...
    with open('donnees.inf', 'w') as fichier:
        ...
        elif seismicParaVar[2]==1 : fichier.write('all\n')
        fichier.write('# 6a. Butterworth filter (if 1 on; if 0 off)\n')
        if text6a0 == 1 : fichier.write('0')
        elif text6a1 == 1 : fichier.write('1')
        ...
        if text6a1.get() == 1:
            fichier.write(text6c1.get() + ", ")
            fichier.write(text6c2.get() + ", ")
            fichier.write(text6c3.get() + '\n')
