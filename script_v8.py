...
class Path:
    ...
    def data(self): 
        ...
        Entry(self.frame, textvariable=text7_1).grid(row=15)
        
        Label(self.frame, text="time window t2 ?").grid(row=16)
        Entry(self.frame, textvariable=text7_2).grid(row=17)
        
        Label(self.frame, text="time window t3 ?").grid(row=18)
        Entry(self.frame, textvariable=text7_3).grid(row=19)
        
        Label(self.frame, text="time window t4 ?").grid(row=20)
        Entry(self.frame, textvariable=text7_4).grid(row=21)
...
class filterswindow:
    ...
    def quitter(self):
        global racine
        racine.destroy()
        afficheSismoFiltre('ABU.20071031.T', float(text6c1.get()), float(text6c2.get()), float(text6c3.get()))
...
def optionFilter():
    ...
    #print str(text6c1.get()) + ", " + str(text6c2.get()) + ", " + str(text6c3.get()) + "\n"
...
def main():
    ...
    with open('donnees.inf', 'w') as fichier:
        ...
        fichier.write(text7_1.get() + ", ")
        fichier.write(text7_2.get() + ", ")
        fichier.write(text7_3.get() + ", ")
        fichier.write(text7_4.get() + "\n")
